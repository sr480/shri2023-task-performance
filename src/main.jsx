...
function Tabs({tabKey, onSize}) {
  if(!tabKey) {
    return undefined;
  }
  return <div key={tabKey} role="tabpanel" className={'section__panel'} id={`panel_${tabKey}`} aria-labelledby={`tab_${tabKey}`}>
    <ul className="section__panel-list">
      {TABS[tabKey].items.map((item, index) =>
        <Event
          key={index}
          {...item}
          onSize={onSize}
  ...
  return <main className="main">
    ...
    <section className="section main__devices">
      ...
      <div className="section__panel-wrapper" ref={ref}>
        <Tabs tabKey={activeTab} onSize={onSize}></Tabs>
        {hasRightScroll &&
